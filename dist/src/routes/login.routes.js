...
const list = __importStar(require("../controller/list.controller"));
const login = __importStar(require("../controller/login.controller"));
const register = __importStar(require("../controller/register.controller"));
const projects = __importStar(require("../controller/projects.controller"));
const auth_1 = require("../middleware/auth");
const router = (0, express_1.Router)();
router.get('/users', auth_1.Auth.private, list.getAllUsers);
